...
////////////console.log("que bota",pp);
  ...
  loadIncidencia(){
    ...
    this.teachersService.getParameterDetail(10).subscribe( res => {      
      ...
      ////////console.log("tipo",this.tipoIncidentes);
    })  
  }
  ...
  LoadSistemas() {
    ...
    // this.teachersService.getIncidencia(this.incidenciaid).subscribe(res =>{
    //   ////////console.log("incidencia",res.objModel);
    //   this.incidenciafal = res.objModel;
    //   if(this.incidenciafal.idEstado == 4){
    //     this.estado.push('Conforme');
    //   }
    //   if(this.incidenciafal.idTipoIncidencia == 78){ 
    //     this.incidencias.push('Redes y comunicaciones');
    //   }else if(this.incidenciafal.idTipoIncidencia == 79){
    //     this.incidencias.push('Software y Sistemas');
    //   }else if(this.incidenciafal.idTipoIncidencia == 80){
    //     this.incidencias.push('Hardware y equipos');
    //   }else if(this.incidenciafal.idTipoIncidencia == 81){
    //     this.incidencias.push('Data y Base de datos');
    //   }else if(this.incidenciafal.idTipoIncidencia == 82){
    //     this.incidencias.push('Consultas');
    //   }
