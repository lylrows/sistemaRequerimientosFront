...
export class TeachersService extends UnsubscribeOnDestroyAdapter {
  ...
  //   );
  // }
  getAllSolutions(listTag):void {
      this.subs.sink = this.httpClient.post<any>(`${environment.api}/incidenciaSolucion/getIncidenciaSolucionesByTagFilter`,listTag).subscribe(
             (data) => {
