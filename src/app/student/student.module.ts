...
import { FormDashboardComponent } from './dashboard/form-dashboard/form-dashboard.component';
...
@NgModule({
  ...
  providers: [ { provide: MAT_DATE_LOCALE, useValue: 'es' },HomeworkService, stdLeaveReqService,StaffService],
})
