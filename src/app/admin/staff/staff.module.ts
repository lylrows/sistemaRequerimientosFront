...
import { FormDilogAccesoComponent } from './all-staff/dialog/form-dilog-acceso/form-dilog-acceso.component';
import { FormNivelSoporteComponent } from './about-staff/form-nivel-soporte/form-nivel-soporte.component';
@NgModule({
  declarations: [
    AllstaffComponent,
    FormDialogComponent,
    ...
    EditStaffComponent,
    AboutStaffComponent,
    FormDilogAccesoComponent,
    FormNivelSoporteComponent,
  ],
  imports: [
    CommonModule,
    FormsModule,
