...
import { incidenciaObj, LstIncidenciaSolArchivo, LstIncidenciaSolPalabra } from 'src/app/system-models/solucionObj';
import { parametroDetalle } from 'src/app/system-models/parametros';
import { COMMA, ENTER } from '@angular/cdk/keycodes';
import { FormImagenDetailComponent } from 'src/app/admin/students/about-student/form-imagen-detail/form-imagen-detail.component';
@Component({
